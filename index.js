...
client.connect(err => {
    const serviceCollection = client.db("klino").collection("service");
    const bookingOrderCollection = client.db("klino").collection("bookingOrder");
    const adminCollection = client.db("klino").collection("admin");
    const reviewCollection = client.db("klino").collection("review");
